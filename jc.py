...
def sendMessageWithMention(to, mid):
    try:
        ...
        logError(error)
def helpmessage():
    helpMessage = """《♥ ✿✿ 𝐹𝒶𝓃𝓉𝒶𝓈𝓎𝒮𝓉𝓊𝒹𝒾𝑜 の Bot ✿✿ ♥》
〘查看指令表〙
【jy:Help】查看全部指令
【HelpTag】查看標註指令
【HelpKick】查看踢人指令
    ...
    try:
        ...
        if op.type == 5:
            ...
            if settings["autoAdd"] == True:
                ...
                cl.sendContact(op.param1, "ub6f9d53713c5869f0d78e71febe13837".format(str(contact.displayName)))
        if op.type == 11:
        ...
        if op.type == 26 or op.type == 25:
            ...
            if msg.contentType == 0:
                if text is None:
                    return
            if sender in admin:
                if msg.text in ["Jy:help","jy:help","by:help","BY:help"]:
